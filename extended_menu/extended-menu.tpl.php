<ul class="links primary-links clearfix op-primary-links">
  ...
  <?php
		...
		$title_link = l($html_title, $top_item->href, array('html' => TRUE,'attributes' => array('class' => array("first-level"))));
      ?>
  <li class="first-level <?php print (isset($top_item->active) ? $top_item->active : "off"); ?> <?php if (isset($top_item->position_class)){ print $top_item->position_class; }?>"> <?php print $title_link; ?>
