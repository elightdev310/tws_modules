...
function twc_click_accept_claim_amount(claim_id) {
    var _url = Drupal.settings.basePath+"ajax/claim/"+claim_id+"/accept";
    jQuery.ajax({
        url:    _url,
        type:   'POST',
        beforeSend: function(jqXHR, settings) {},
...
function twc_click_decline_claim_amount(claim_id) {
    var _url = Drupal.settings.basePath+"ajax/claim/"+claim_id+"/decline";
    jQuery.ajax({
        url:    _url,
        type:   'POST',
        beforeSend: function(jqXHR, settings) {},
