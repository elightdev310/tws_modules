		...
		<div style="width: 100%; background-color: white;">
			<div style="width: 540px; margin: 0px auto; padding: 10px 0px;">
				...
				<div style="font-size: 26px; color: #1d5ca8; margin:15px 0px;">
					<b>Congratulations!</b> 
					<div>on creating your first claim with True Water Claims!</div>
				</div>
				...
				<div style="margin:15px 0px;" >
					If you receive any delay or resistance of payment on any claims that you've created with True Water Claims, your Account Manager is here to help you navigate communication with the insurance company and adjusters. With the goal of getting you paid quickly and in full, your Account Manager has extensive knowledge and documentation that will help you when discussing your invoice with the insurance carrier.
				</div>
				...
				<table width="100%" style="font-size: 12px;"><tr>
					<td width="220px" style="vertical-align: top;">
						<div style="margin-right: 15px;">
							<b>Please contact your True Water Claims account manager if you have any questions. </b>
							<br/><br/>
